...
# A note on the use of "AI-tools" like ChatGPT, Claude, Gemini, etc.

AI-tools can be very helpful for gathering information (like an advanced search engine) and for executing simple tasks (like a research assistant). However, it is important that students build some foundational knowledge in econometrics, which is necessary to conduct empirical economic analyses of value*. How else to know what to even ask ChatGPT or how to interpret its responses?! Sure, someone who's never heard of econometrics could still pass on a question they received to the AI-tool and let it explain in detail, but (i) this would result in poor quality, and/or (ii) this would amount to learning econometrics then, with the AI. The bottom line is that you must eventually understand econometrics to conduct valuable empirical economic analyses.

Given that the foundational econometrics topics we discuss are common knowledge (and generally rather simple in the grand scheme of things out there), it is likely that AI-tools can answer most Problem Set (PS) questions satisfactorily. This is why I prefer to rely on exams and (individual) term papers for assessing student performance; in the former, no AI-tool is available, and in the latter, students have to perform an actual, in-depth economic analysis* of some research question, for which they have to do the reasoning and legwork themselves (while possibly passing on simpler tasks to an AI-tool).
